...
public class TokenService {
	...
	@Value("${maustratos.jwt.expiration}")
	private String expiration;

	@Value("${maustratos.jwt.secret}")
	...
	public String gerarToken(Authentication authentication) {
		...
		return Jwts.builder().setIssuer("API - Denuncia maus tratos animais").setSubject(logado.getId().toString())
